...
contract XBasisStrategyTest is OffChainTest {
    ...
    function setUp() public {
        ...
        // deploy mock spot manager
        spotManager = new MockXSpotManager();
        spotManager.initialize(owner, address(strategy), pathWeth);
    ...
    function _syncSpotExposure() internal {
        ...
        stdstore.target(manager).sig(MockXSpotManager(manager).exposure.selector).checked_write(balance);
    }
