...
library MarketUtils {
    ...
    function getMarketTokenPrice(
        ...
        bool maximize
    ) internal view returns (int256, MarketPoolValueInfo.Props memory) {
        uint256 supply = getMarketTokenSupply(IERC20(payable(market.marketToken)));
    ...
    function getMarketTokenSupply(IERC20 marketToken) internal view returns (uint256) {
    ...
    function validateSwapMarket(IDataStore dataStore, address marketAddress) internal view {
        Market.Props memory market = MarketStoreUtils.get(dataStore, marketAddress);
        validateSwapMarket(dataStore, market);
    }

    function validateSwapMarket(IDataStore dataStore, Market.Props memory market) internal view {
    ...
    function getPoolAmount(IDataStore dataStore, Market.Props memory market, address token)
        internal
        view
        returns (uint256)
    {
    ...
    function getMaxPoolAmount(IDataStore dataStore, address market, address token) internal view returns (uint256) {
    ...
    function getMaxPoolAmountForDeposit(IDataStore dataStore, address market, address token)
        internal
        view
        returns (uint256)
    {
    ...
    function getAdjustedSwapImpactFactor(IDataStore dataStore, address market, bool isPositive)
        internal
        view
        returns (uint256)
    {
    ...
    function getAdjustedSwapImpactFactors(IDataStore dataStore, address market)
        internal
        view
    ...
    function getAdjustedPositionImpactFactor(IDataStore dataStore, address market, bool isPositive)
        internal
        view
        returns (uint256)
    {
    ...
    function getAdjustedPositionImpactFactors(IDataStore dataStore, address market)
        internal
        view
        returns (uint256, uint256)
    {
    ...
    function getPositionImpactPoolAmount(IDataStore dataStore, address market) internal view returns (uint256) {
    ...
    function getSwapImpactPoolAmount(IDataStore dataStore, address market, address token)
        internal
        view
        returns (uint256)
    {
    ...
    function getNextFundingAmountPerSize(IDataStore dataStore, Market.Props memory market, MarketPrices memory prices)
        internal
        view
    ...
    function getPnlToPoolFactor(IDataStore dataStore, IOracle oracle, address market, bool isLong, bool maximize)
        internal
        view
        returns (int256)
    {
    ...
    function validateOpenInterest(IDataStore dataStore, Market.Props memory market, bool isLong) internal view {
    ...
    // @param market the market to check
    // @param token the token to check
    function validatePoolAmount(IDataStore dataStore, Market.Props memory market, address token) internal view {
        uint256 poolAmount = getPoolAmount(dataStore, market, token);
    ...
    // @param market the market to check
    // @param token the token to check
    function validatePoolAmountForDeposit(IDataStore dataStore, Market.Props memory market, address token)
        internal
        view
    {
        uint256 poolAmount = getPoolAmount(dataStore, market, token);
    ...
    function validateReserve(IDataStore dataStore, Market.Props memory market, MarketPrices memory prices, bool isLong)
        internal
        view
    {
    ...
    function getBorrowingFees(IDataStore dataStore, Position.Props memory position) internal view returns (uint256) {
    ...
    function getVirtualInventoryForSwaps(IDataStore dataStore, address market)
        internal
        view
    ...
    // @param dataStore IDataStore
    // @param token the token to check
    function getVirtualInventoryForPositions(IDataStore dataStore, address token)
        internal
        view
        returns (bool, int256)
    {
    ...
    function getMaxPositionImpactFactor(IDataStore dataStore, address market, bool isPositive)
        internal
        view
        returns (uint256)
    {
    ...
    function getMaxPositionImpactFactors(IDataStore dataStore, address market)
        internal
        view
        returns (uint256, uint256)
    {
    ...
    function getReserveFactor(IDataStore dataStore, address market, bool isLong) internal view returns (uint256) {
    ...
    function getOpenInterestReserveFactor(IDataStore dataStore, address market, bool isLong)
        internal
        view
        returns (uint256)
    {
    ...
    function getMaxPnlFactor(IDataStore dataStore, bytes32 pnlFactorType, address market, bool isLong)
        internal
        view
        returns (uint256)
    {
    ...
    // @param market the market to check
    // @param isLong whether to check the long or short side
    function getMinPnlFactorAfterAdl(IDataStore dataStore, address market, bool isLong)
        internal
        view
        returns (uint256)
    {
    ...
    function getFundingFactor(IDataStore dataStore, address market) internal view returns (uint256) {
    ...
    function getSavedFundingFactorPerSecond(IDataStore dataStore, address market) internal view returns (int256) {
    ...
    function getFundingExponentFactor(IDataStore dataStore, address market) internal view returns (uint256) {
    ...
    function getSecondsSinceFundingUpdated(IDataStore dataStore, address market) internal view returns (uint256) {
    ...
    function getBorrowingFactor(IDataStore dataStore, address market, bool isLong) internal view returns (uint256) {
    ...
    function getBorrowingExponentFactor(IDataStore dataStore, address market, bool isLong)
        internal
        view
        returns (uint256)
    {
    ...
    function getCumulativeBorrowingFactorUpdatedAt(IDataStore dataStore, address market, bool isLong)
        internal
        view
        returns (uint256)
    {
    ...
    function getSecondsSinceCumulativeBorrowingFactorUpdated(IDataStore dataStore, address market, bool isLong)
        internal
        view
        returns (uint256)
    {
    ...
    function getNextPositionImpactPoolAmount(IDataStore dataStore, address market) internal view returns (uint256) {
    ...
    function getPendingPositionImpactPoolDistributionAmount(IDataStore dataStore, address market)
        internal
        view
        returns (uint256, uint256)
    {
    ...
    function getSecondsSincePositionImpactPoolDistributed(IDataStore dataStore, address market)
        internal
        view
        returns (uint256)
    {
    ...
    function getTotalBorrowing(IDataStore dataStore, address market, bool isLong) internal view returns (uint256) {
    ...
    function validateEnabledMarket(IDataStore dataStore, address marketAddress) internal view {
        Market.Props memory market = MarketStoreUtils.get(dataStore, marketAddress);
        validateEnabledMarket(dataStore, market);
    }
    ...
    // @param dataStore IDataStore
    // @param market the market to check
    function validateEnabledMarket(IDataStore dataStore, Market.Props memory market) internal view {
    ...
    // @param market the market to check
    function validatePositionMarket(IDataStore dataStore, Market.Props memory market) internal view {
        validateEnabledMarket(dataStore, market);
    ...
    function validatePositionMarket(IDataStore dataStore, address marketAddress) internal view {
        Market.Props memory market = MarketStoreUtils.get(dataStore, marketAddress);
    ...
    // @param dataStore IDataStore
    // @param marketAddress the address of the market
    function getEnabledMarket(IDataStore dataStore, address marketAddress)
        internal
        view
    ...
    function getSwapPathMarket(IDataStore dataStore, address marketAddress)
        internal
        view
        returns (Market.Props memory)
    {
    ...
    function getSwapPathMarkets(IDataStore dataStore, address[] memory swapPath)
        internal
        view
        returns (Market.Props[] memory)
    {
    ...
    function validateSwapPath(IDataStore dataStore, address[] memory swapPath) internal view {
    ...
    function getUiFeeFactor(IDataStore dataStore, address account) internal view returns (uint256) {
    ...
    function validateMarketTokenBalance(IDataStore dataStore, Market.Props[] memory markets) internal view {
        for (uint256 i; i < markets.length; i++) {
            validateMarketTokenBalance(dataStore, markets[i]);
        }
    }

    function validateMarketTokenBalance(IDataStore dataStore, address _market) internal view {
        Market.Props memory market = getEnabledMarket(dataStore, _market);
        validateMarketTokenBalance(dataStore, market);
    }

    function validateMarketTokenBalance(IDataStore dataStore, Market.Props memory market) internal view {
    ...
    function validateMarketTokenBalance(IDataStore dataStore, Market.Props memory market, address token)
        internal
        view
    {
    ...
    function getExpectedMinTokenBalance(IDataStore dataStore, Market.Props memory market, address token)
        internal
        view
        returns (uint256)
    {
