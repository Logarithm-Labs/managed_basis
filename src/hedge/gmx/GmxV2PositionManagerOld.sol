...
contract GmxV2PositionManagerOld is Initializable, IHedgeManager, IOrderCallbackReceiver, IGasFeeCallbackReceiver {
    ...
    function reinitialize(address newGasStation) external reinitializer(3) {
        _getGmxV2PositionManagerStorage().gasStation = newGasStation;
    }
