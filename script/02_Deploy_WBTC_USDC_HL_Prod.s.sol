...
contract ArbDeploy is Script {
    ...
    address constant operator = 0xE32b95441C23D87906929F2Dae25B9E9DD62F1B1;
    address constant agent = 0xEdD0D94a267550C926cbe4A1A562157945cc6c6c;

    // vault params
    uint256 constant entryCost = 0.0035 ether; // 0.35% entry fee
    uint256 constant exitCost = 0.0035 ether; // 0.35% exit fee
    string constant vaultName = "BasisOS USDC-WBTC Hyperliquid";
    string constant vaultSymbol = "basisos-usdc-wbtc-hl";
    // Strategy Addresses
    ...
    uint256 constant safeMarginLeverage = 16 ether;
    // fee params
    ...
    uint256 constant vaultDepositLimit = 5_000_000 * 1e6; // 5,000,000 USDC
